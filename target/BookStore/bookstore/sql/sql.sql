...
DROP TABLE IF EXISTS `BOOKCARTS`;
CREATE TABLE `BOOKCARTS` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(11) DEFAULT NULL,
  `bookid` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
  CONSTRAINT `usercart` FOREIGN KEY (`userid`) REFERENCES `USERS` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
  CONSTRAINT `bookcart` FOREIGN KEY (`bookid`) REFERENCES `BOOKS` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
